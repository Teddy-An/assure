...
MESSAGES = {
    "en": {
        ...
        "report.mode_project-test": "Project test",
        "report.mode_functional-probe": "Functional probe",
    ...
    "ko": {
        ...
        "report.mode_project-test": "프로젝트 테스트",
        "report.mode_functional-probe": "기능 프로브",
